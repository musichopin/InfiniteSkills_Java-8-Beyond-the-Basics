...
public class BoxLayoutExample extends JFrame
{
	public BoxLayoutExample()
	{
		...
		jp.setLayout(new BoxLayout(jp, BoxLayout.Y_AXIS)); // X_AXIS de seçilebilirdi
		...
		jp.add(w);
		jp.add(c);
//		first adding the buttons to the panel and then
//		adding panel to the contentpane of this frame
