...
// RaceManager is our driving frame and class
	
	private JPanel contentPane;
	public static InfiniteSkillsRace _isr; // _isr: available for other classes
...
//		flat text file: txt, System state file: bin (created after the program is saved in the app)
		if (choice.equals("1"))
		{
			try
			{
